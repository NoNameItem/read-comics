...
class Concept(ImageMixin, ComicvineSyncModel):
    ...
    COMICVINE_INFO_TASK = concept_comicvine_info_task
    COMICVINE_API_URL = (
        "https://comicvine.gamespot.com/api/concept/4015-{id}/?"
        "api_key={api_key}&"
        "format=json&"
    ...
    first_issue = models.ForeignKey(
        "issues.Issue", null=True, on_delete=models.SET_NULL, related_name="first_appearance_concepts"
    )
    ...
    def get_absolute_url(self):
        ...
        return reverse("concepts:detail", args=[self.slug])
