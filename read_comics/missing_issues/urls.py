...
urlpatterns = [
    ...
    path(
        "watched/ignore_publisher/<int:comicvine_id>/",
        view=watched_ignore_publisher_view,
    ...
    path(
        "<str:category>/<str:slug>/skip_volume/<int:comicvine_id>/", view=skip_volume_view, name="category_skip_volume"
    ),
    path(
        "<str:category>/<str:slug>/skip_publisher/<int:comicvine_id>/",
        view=skip_publisher_view,
        name="category_skip_publisher",
    ),
    path(
        "<str:category>/<str:slug>/ignore_issue/<int:comicvine_id>/",
        view=ignore_issue_view,
        name="category_ignore_issue",
    ),
    path(
        "<str:category>/<str:slug>/ignore_volume/<int:comicvine_id>/",
        view=ignore_volume_view,
        name="category_ignore_volume",
    ),
    path(
        "<str:category>/<str:slug>/ignore_publisher/<int:comicvine_id>/",
        view=ignore_publisher_view,
