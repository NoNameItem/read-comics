    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publisher', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='missing_issues', to='publishers.publisher')),
                ...
                ('volume', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='missing_issues', to='volumes.volume')),
            ],
        ),
    ]
