# Docs: [[docs/backend/locations/models.md]]
...
class Location(ImageMixin, DownloadSizeMixin, AliasesListMixin, ComicvineSyncModel):
    ...
    COMICVINE_API_URL = (
        "https://comicvine.gamespot.com/api/location/4020-{id}/?"
        "api_key={api_key}&"
        "format=json&"
    ...
    first_issue = models.ForeignKey(
        "issues.Issue", null=True, on_delete=models.SET_NULL, related_name="first_appearance_locations"
    )
