...
class StoryArc(ImageMixin, ComicvineSyncModel):
    ...
    COMICVINE_API_URL = 'https://comicvine.gamespot.com/api/story_arc/4045-{id}/?' \
                        'api_key={api_key}&' \
                        'format=json&' \
    ...
    publisher = models.ForeignKey('publishers.Publisher', related_name='story_arcs', on_delete=models.CASCADE,
                                  null=True)
