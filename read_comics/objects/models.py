...
from objects.tasks import object_comicvine_info_task
...
logger = getLogger(__name__ + '.Object')
...
class Object(ImageMixin, ComicvineSyncModel):
    ...
    COMICVINE_API_URL = 'https://comicvine.gamespot.com/api/object/4055-{id}/?' \
                        'api_key={api_key}&' \
                        'format=json&' \
    ...
    first_issue = models.ForeignKey('issues.Issue', null=True, on_delete=models.SET_NULL,
                                    related_name='first_appearance_objects')
