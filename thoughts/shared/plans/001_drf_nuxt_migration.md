# DRF + Nuxt Migration Plan

High-level migration plan from Django views to DRF API + Nuxt frontend.

**References:**
- `REFACTORING_PLAN.md` - Detailed page/block breakdown with Jira tickets
- `DRF_MIGRATION_URL_MAP.md` - API endpoint status mapping
- `thoughts/shared/research/001_high_level_architecture.md` - Architecture research

**Legend:**
- OK: endpoint exists and is ready
- NEEDS WORK: endpoint exists but requires changes (detail serializer, slug lookup)
- PLAN: endpoint not implemented yet
- N/A: no API needed (Django-only or handled differently)

---

## Phase 1: Authentication & User Pages

### Task: Login page ([RC-257](https://nonameitem.atlassian.net/browse/RC-257))
Description: Django URL: `/accounts/login/` (allauth), Nuxt: `/users/login`
Tags: auth, users
Subtasks:
- Login form — endpoints: /api/auth/login/ [OK (dj-rest-auth)] | tags: auth | Jira: [RC-268](https://nonameitem.atlassian.net/browse/RC-268)
- Remember me — endpoints: N/A (frontend token storage) | tags: auth | Jira: [RC-269](https://nonameitem.atlassian.net/browse/RC-269)

### Task: Registration page ([RC-258](https://nonameitem.atlassian.net/browse/RC-258))
Description: Django URL: `/accounts/signup/` (allauth), Nuxt: `/users/register`
Tags: auth, users
Subtasks:
- Registration form — endpoints: /api/auth/registration/ [OK (dj-rest-auth)] | tags: auth | Jira: [RC-270](https://nonameitem.atlassian.net/browse/RC-270)
- Email verification notice — endpoints: N/A (frontend UI) | tags: auth | Jira: [RC-271](https://nonameitem.atlassian.net/browse/RC-271)

### Task: Email verification page ([RC-259](https://nonameitem.atlassian.net/browse/RC-259))
Description: Django URL: `/accounts/confirm-email/<key>/` (allauth), Nuxt: `/users/confirm-email/[key]`
Tags: auth, users
Subtasks:
- Confirm email — endpoints: /api/auth/registration/verify-email/ [OK (dj-rest-auth)] | tags: auth | Jira: [RC-272](https://nonameitem.atlassian.net/browse/RC-272)
- Resend verification — endpoints: /api/auth/registration/resend-email/ [OK (dj-rest-auth)] | tags: auth | Jira: [RC-273](https://nonameitem.atlassian.net/browse/RC-273)

### Task: Verify email prompt page ([RC-260](https://nonameitem.atlassian.net/browse/RC-260))
Description: Django URL: `/accounts/email/` (allauth), Nuxt: `/users/verify-email`
Tags: auth, users
Subtasks:
- Verification status — endpoints: /api/auth/user/ [OK (dj-rest-auth)] | tags: auth | Jira: [RC-274](https://nonameitem.atlassian.net/browse/RC-274)
- Resend button — endpoints: /api/auth/registration/resend-email/ [OK (dj-rest-auth)] | tags: auth | Jira: [RC-275](https://nonameitem.atlassian.net/browse/RC-275)

### Task: Password reset request page ([RC-261](https://nonameitem.atlassian.net/browse/RC-261))
Description: Django URL: `/accounts/password/reset/` (allauth), Nuxt: `/users/reset-password`
Tags: auth, users
Subtasks:
- Reset form — endpoints: /api/auth/password/reset/ [OK (dj-rest-auth)] | tags: auth | Jira: [RC-276](https://nonameitem.atlassian.net/browse/RC-276)
- Success message — endpoints: N/A (frontend UI) | tags: auth | Jira: [RC-277](https://nonameitem.atlassian.net/browse/RC-277)

### Task: Password reset confirm page ([RC-262](https://nonameitem.atlassian.net/browse/RC-262))
Description: Django URL: `/accounts/password/reset/key/<key>/` (allauth), Nuxt: `/users/password-reset-confirm/[uid]/[token]`
Tags: auth, users
Subtasks:
- New password form — endpoints: /api/auth/password/reset/confirm/ [OK (dj-rest-auth)] | tags: auth | Jira: [RC-278](https://nonameitem.atlassian.net/browse/RC-278)
- Validation errors — endpoints: N/A (frontend validation) | tags: auth | Jira: [RC-279](https://nonameitem.atlassian.net/browse/RC-279)

### Task: User profile page ([RC-263](https://nonameitem.atlassian.net/browse/RC-263))
Description: Django URL: `/users/<username>/`, Nuxt: `/users/profile`
Tags: users
Subtasks:
- User info panel — endpoints: /api/auth/user/ [OK (dj-rest-auth)]; /api/profile/ [OK] | tags: users | Jira: [RC-280](https://nonameitem.atlassian.net/browse/RC-280)
- Edit user info — endpoints: /api/auth/user/ [OK (PATCH)] | tags: users | Jira: [RC-281](https://nonameitem.atlassian.net/browse/RC-281)
- Change avatar — endpoints: /api/profile/change-photo/ [PLAN] | tags: users | Jira: [RC-282](https://nonameitem.atlassian.net/browse/RC-282)
- Delete avatar — endpoints: /api/profile/delete-photo/ [PLAN] | tags: users | Jira: [RC-283](https://nonameitem.atlassian.net/browse/RC-283)
- Change password — endpoints: /api/auth/password/change/ [OK (dj-rest-auth)] | tags: users | Jira: [RC-284](https://nonameitem.atlassian.net/browse/RC-284)
- Change email — endpoints: /api/profile/change-email/ [OK] | tags: users | Jira: [RC-285](https://nonameitem.atlassian.net/browse/RC-285)
- Reading statistics — endpoints: /api/profile/finished-stats/ [OK] | tags: users | Jira: [RC-286](https://nonameitem.atlassian.net/browse/RC-286)

### Task: Logout ([RC-264](https://nonameitem.atlassian.net/browse/RC-264))
Description: Action, no dedicated page
Tags: auth, users
Subtasks:
- Logout action — endpoints: /api/auth/logout/ [OK (dj-rest-auth)] | tags: auth | Jira: [RC-287](https://nonameitem.atlassian.net/browse/RC-287)
...
- Update history — endpoints: /api/issues/update-history/ [PLAN] | tags: home, issues | Jira: [RC-32](https://nonameitem.atlassian.net/browse/RC-32)
...
Tags: issues
Subtasks:
- Page data — endpoints: /api/issues/by-date/<year>/<month>/<day>/ [PLAN] | tags: issues | Jira: [RC-171](https://nonameitem.atlassian.net/browse/RC-171)
...
## Phase 4: Entity Detail Pages (Full API Ready)

These entities have list AND detail endpoints ready.
...
- Reading progress (volume) — endpoints: /api/volumes/<slug>/ [NEEDS WORK (detail serializer); slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:165) | tags: issues, volumes | Jira: [RC-226](https://nonameitem.atlassian.net/browse/RC-226)
...
## Phase 5: Entity Detail Pages (Need Detail Serializer + Slug Lookup)

These entities need backend work before frontend migration.
...
Tags: objects
Subtasks:
- Header + Tab selector — endpoints: /api/objects/<slug>/ [NEEDS WORK (detail serializer); slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:85) | tags: objects | Jira: [RC-204](https://nonameitem.atlassian.net/browse/RC-204)
- Reading progress — endpoints: /api/objects/<slug>/ [NEEDS WORK] (ref: DRF_MIGRATION_URL_MAP.md:85) | tags: objects | Jira: [RC-205](https://nonameitem.atlassian.net/browse/RC-205)
- Main info tab — endpoints: /api/objects/<slug>/ [NEEDS WORK] (ref: DRF_MIGRATION_URL_MAP.md:85) | tags: objects | Jira: [RC-79](https://nonameitem.atlassian.net/browse/RC-79)
- Issues tab — endpoints: /api/objects/<slug>/issues/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:89) | tags: issues, objects | Jira: [RC-81](https://nonameitem.atlassian.net/browse/RC-81)
- Volumes tab — endpoints: /api/objects/<slug>/volumes/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:90) | tags: objects, volumes | Jira: [RC-82](https://nonameitem.atlassian.net/browse/RC-82)
- Missing issues link (staff) — endpoints: no DRF endpoint [N/A] | tags: objects, missing-issues | Jira: [RC-206](https://nonameitem.atlassian.net/browse/RC-206)
- Technical info tab — endpoints: /api/objects/<slug>/technical-info/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:86) | tags: objects | Jira: [RC-80](https://nonameitem.atlassian.net/browse/RC-80)
- Start/stop watch — endpoints: /api/objects/<slug>/start-watch/ [PLAN]; /api/objects/<slug>/stop-watch/ [PLAN] | tags: objects | Jira: [RC-83](https://nonameitem.atlassian.net/browse/RC-83)
...
Tags: people
Subtasks:
- Header + Tab selector — endpoints: /api/people/<slug>/ [NEEDS WORK (detail serializer); slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:97) | tags: people | Jira: [RC-207](https://nonameitem.atlassian.net/browse/RC-207)
- Reading progress — endpoints: /api/people/<slug>/ [NEEDS WORK] (ref: DRF_MIGRATION_URL_MAP.md:97) | tags: people | Jira: [RC-208](https://nonameitem.atlassian.net/browse/RC-208)
- Main info tab — endpoints: /api/people/<slug>/ [NEEDS WORK] (ref: DRF_MIGRATION_URL_MAP.md:97) | tags: people | Jira: [RC-85](https://nonameitem.atlassian.net/browse/RC-85)
- Issues tab — endpoints: /api/people/<slug>/issues/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:101) | tags: issues, people | Jira: [RC-87](https://nonameitem.atlassian.net/browse/RC-87)
- Volumes tab — endpoints: /api/people/<slug>/volumes/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:102) | tags: people, volumes | Jira: [RC-88](https://nonameitem.atlassian.net/browse/RC-88)
- Characters tab — endpoints: /api/people/<slug>/characters/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:103) | tags: characters, people | Jira: [RC-89](https://nonameitem.atlassian.net/browse/RC-89)
- Missing issues link (staff) — endpoints: no DRF endpoint [N/A] | tags: people, missing-issues | Jira: [RC-209](https://nonameitem.atlassian.net/browse/RC-209)
- Technical info tab — endpoints: /api/people/<slug>/technical-info/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:98) | tags: people | Jira: [RC-86](https://nonameitem.atlassian.net/browse/RC-86)
- Start/stop watch — endpoints: /api/people/<slug>/start-watch/ [PLAN]; /api/people/<slug>/stop-watch/ [PLAN] | tags: people | Jira: [RC-91](https://nonameitem.atlassian.net/browse/RC-91)
...
Tags: publishers
Subtasks:
- Header + Tab selector — endpoints: /api/publishers/<slug>/ [NEEDS WORK (detail serializer); slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:110) | tags: publishers | Jira: [RC-210](https://nonameitem.atlassian.net/browse/RC-210)
- Reading progress — endpoints: /api/publishers/<slug>/ [NEEDS WORK] (ref: DRF_MIGRATION_URL_MAP.md:110) | tags: publishers | Jira: [RC-211](https://nonameitem.atlassian.net/browse/RC-211)
- Main info tab — endpoints: /api/publishers/<slug>/ [NEEDS WORK] (ref: DRF_MIGRATION_URL_MAP.md:110) | tags: publishers | Jira: [RC-92](https://nonameitem.atlassian.net/browse/RC-92)
- Issues tab — endpoints: /api/publishers/<slug>/issues/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:114) | tags: issues, publishers | Jira: [RC-94](https://nonameitem.atlassian.net/browse/RC-94)
- Volumes tab — endpoints: /api/publishers/<slug>/volumes/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:118) | tags: publishers, volumes | Jira: [RC-95](https://nonameitem.atlassian.net/browse/RC-95)
- Characters tab — endpoints: /api/publishers/<slug>/characters/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:115) | tags: characters, publishers | Jira: [RC-96](https://nonameitem.atlassian.net/browse/RC-96)
- Story arcs tab — endpoints: /api/publishers/<slug>/story-arcs/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:117) | tags: publishers, story-arcs | Jira: [RC-97](https://nonameitem.atlassian.net/browse/RC-97)
- Teams tab — endpoints: /api/publishers/<slug>/teams/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:116) | tags: publishers, teams | Jira: [RC-98](https://nonameitem.atlassian.net/browse/RC-98)
- Missing issues link (staff) — endpoints: no DRF endpoint [N/A] | tags: publishers, missing-issues | Jira: [RC-212](https://nonameitem.atlassian.net/browse/RC-212)
- Technical info tab — endpoints: /api/publishers/<slug>/technical-info/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:111) | tags: publishers | Jira: [RC-93](https://nonameitem.atlassian.net/browse/RC-93)
- Start/stop watch — endpoints: /api/publishers/<slug>/start-watch/ [PLAN]; /api/publishers/<slug>/stop-watch/ [PLAN] | tags: publishers | Jira: [RC-100](https://nonameitem.atlassian.net/browse/RC-100)
...
Tags: story-arcs
Subtasks:
- Header + Tab selector — endpoints: /api/story-arcs/<slug>/ [NEEDS WORK (detail serializer); slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:126) | tags: story-arcs | Jira: [RC-213](https://nonameitem.atlassian.net/browse/RC-213)
- Reading progress — endpoints: /api/story-arcs/<slug>/ [NEEDS WORK] (ref: DRF_MIGRATION_URL_MAP.md:126) | tags: story-arcs | Jira: [RC-214](https://nonameitem.atlassian.net/browse/RC-214)
- Main info tab — endpoints: /api/story-arcs/<slug>/ [NEEDS WORK] (ref: DRF_MIGRATION_URL_MAP.md:126) | tags: story-arcs | Jira: [RC-101](https://nonameitem.atlassian.net/browse/RC-101)
- Issues tab — endpoints: /api/story-arcs/<slug>/issues/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:139) | tags: issues, story-arcs | Jira: [RC-103](https://nonameitem.atlassian.net/browse/RC-103)
- Volumes tab — endpoints: /api/story-arcs/<slug>/volumes/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:142) | tags: story-arcs, volumes | Jira: [RC-104](https://nonameitem.atlassian.net/browse/RC-104)
- Characters tab — endpoints: /api/story-arcs/<slug>/characters/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:133) | tags: characters, story-arcs | Jira: [RC-106](https://nonameitem.atlassian.net/browse/RC-106)
- Died tab — endpoints: /api/story-arcs/<slug>/died/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:131) | tags: story-arcs, characters | Jira: [RC-107](https://nonameitem.atlassian.net/browse/RC-107)
- Concepts tab — endpoints: /api/story-arcs/<slug>/concepts/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:134) | tags: concepts, story-arcs | Jira: [RC-108](https://nonameitem.atlassian.net/browse/RC-108)
- Locations tab — endpoints: /api/story-arcs/<slug>/locations/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:138) | tags: locations, story-arcs | Jira: [RC-109](https://nonameitem.atlassian.net/browse/RC-109)
- Objects tab — endpoints: /api/story-arcs/<slug>/objects/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:140) | tags: objects, story-arcs | Jira: [RC-110](https://nonameitem.atlassian.net/browse/RC-110)
- Authors tab — endpoints: /api/story-arcs/<slug>/authors/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:132) | tags: story-arcs | Jira: [RC-111](https://nonameitem.atlassian.net/browse/RC-111)
- Teams tab — endpoints: /api/story-arcs/<slug>/teams/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:141) | tags: story-arcs, teams | Jira: [RC-112](https://nonameitem.atlassian.net/browse/RC-112)
- Disbanded tab — endpoints: /api/story-arcs/<slug>/disbanded/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:135) | tags: story-arcs, teams | Jira: [RC-113](https://nonameitem.atlassian.net/browse/RC-113)
- First appearances tab — endpoints: /api/story-arcs/<slug>/first-appearances/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:136) | tags: story-arcs | Jira: [RC-105](https://nonameitem.atlassian.net/browse/RC-105)
- Missing issues link (staff) — endpoints: no DRF endpoint [N/A] | tags: story-arcs, missing-issues | Jira: [RC-215](https://nonameitem.atlassian.net/browse/RC-215)
- Technical info tab — endpoints: /api/story-arcs/<slug>/technical-info/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:127) | tags: story-arcs | Jira: [RC-102](https://nonameitem.atlassian.net/browse/RC-102)
- Start/stop watch — endpoints: /api/story-arcs/<slug>/start-watch/ [PLAN]; /api/story-arcs/<slug>/stop-watch/ [PLAN] | tags: story-arcs | Jira: [RC-116](https://nonameitem.atlassian.net/browse/RC-116)
- Mark finished — endpoints: /api/story-arcs/<slug>/mark-finished/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:130) | tags: story-arcs | Jira: [RC-114](https://nonameitem.atlassian.net/browse/RC-114)
...
Tags: teams
Subtasks:
- Header + Tab selector — endpoints: /api/teams/<slug>/ [NEEDS WORK (detail serializer); slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:148) | tags: teams | Jira: [RC-216](https://nonameitem.atlassian.net/browse/RC-216)
- Reading progress — endpoints: /api/teams/<slug>/ [NEEDS WORK] (ref: DRF_MIGRATION_URL_MAP.md:148) | tags: teams | Jira: [RC-217](https://nonameitem.atlassian.net/browse/RC-217)
- Main info tab — endpoints: /api/teams/<slug>/ [NEEDS WORK] (ref: DRF_MIGRATION_URL_MAP.md:148) | tags: teams | Jira: [RC-119](https://nonameitem.atlassian.net/browse/RC-119)
- Issues tab — endpoints: /api/teams/<slug>/issues/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:153) | tags: issues, teams | Jira: [RC-121](https://nonameitem.atlassian.net/browse/RC-121)
- Volumes tab — endpoints: /api/teams/<slug>/volumes/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:155) | tags: teams, volumes | Jira: [RC-122](https://nonameitem.atlassian.net/browse/RC-122)
- Disbanded in issues tab — endpoints: /api/teams/<slug>/disbanded-in/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:158) | tags: teams | Jira: [RC-126](https://nonameitem.atlassian.net/browse/RC-126)
- Members tab — endpoints: /api/teams/<slug>/characters/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:157) | tags: characters, teams | Jira: [RC-123](https://nonameitem.atlassian.net/browse/RC-123)
- Friends tab — endpoints: /api/teams/<slug>/friends/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:156) | tags: teams | Jira: [RC-125](https://nonameitem.atlassian.net/browse/RC-125)
- Enemies tab — endpoints: /api/teams/<slug>/enemies/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:154) | tags: teams | Jira: [RC-124](https://nonameitem.atlassian.net/browse/RC-124)
- Missing issues link (staff) — endpoints: no DRF endpoint [N/A] | tags: teams, missing-issues | Jira: [RC-218](https://nonameitem.atlassian.net/browse/RC-218)
- Technical info tab — endpoints: /api/teams/<slug>/technical-info/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:149) | tags: teams | Jira: [RC-120](https://nonameitem.atlassian.net/browse/RC-120)
- Start/stop watch — endpoints: /api/teams/<slug>/start-watch/ [PLAN]; /api/teams/<slug>/stop-watch/ [PLAN] | tags: teams | Jira: [RC-128](https://nonameitem.atlassian.net/browse/RC-128)
...
Tags: volumes
Subtasks:
- Header + Tab selector — endpoints: /api/volumes/<slug>/ [NEEDS WORK (detail serializer); slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:165) | tags: volumes | Jira: [RC-219](https://nonameitem.atlassian.net/browse/RC-219)
- Reading progress — endpoints: /api/volumes/<slug>/ [NEEDS WORK] (ref: DRF_MIGRATION_URL_MAP.md:165) | tags: volumes | Jira: [RC-220](https://nonameitem.atlassian.net/browse/RC-220)
- Main info tab — endpoints: /api/volumes/<slug>/ [NEEDS WORK] (ref: DRF_MIGRATION_URL_MAP.md:165) | tags: volumes | Jira: [RC-221](https://nonameitem.atlassian.net/browse/RC-221)
- Issues tab — endpoints: /api/volumes/<slug>/issues/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:171) | tags: issues, volumes | Jira: [RC-129](https://nonameitem.atlassian.net/browse/RC-129)
- Characters tab — endpoints: /api/volumes/<slug>/characters/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:172) | tags: characters, volumes | Jira: [RC-131](https://nonameitem.atlassian.net/browse/RC-131)
- Characters died tab — endpoints: /api/volumes/<slug>/died/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:173) | tags: characters, volumes | Jira: [RC-132](https://nonameitem.atlassian.net/browse/RC-132)
- Concepts tab — endpoints: /api/volumes/<slug>/concepts/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:174) | tags: concepts, volumes | Jira: [RC-133](https://nonameitem.atlassian.net/browse/RC-133)
- Locations tab — endpoints: /api/volumes/<slug>/locations/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:175) | tags: locations, volumes | Jira: [RC-134](https://nonameitem.atlassian.net/browse/RC-134)
- Objects tab — endpoints: /api/volumes/<slug>/objects/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:176) | tags: objects, volumes | Jira: [RC-135](https://nonameitem.atlassian.net/browse/RC-135)
- Authors tab — endpoints: /api/volumes/<slug>/authors/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:177) | tags: volumes | Jira: [RC-136](https://nonameitem.atlassian.net/browse/RC-136)
- Story arcs tab — endpoints: /api/volumes/<slug>/story-arcs/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:178) | tags: story-arcs, volumes | Jira: [RC-137](https://nonameitem.atlassian.net/browse/RC-137)
- Teams tab — endpoints: /api/volumes/<slug>/teams/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:179) | tags: teams, volumes | Jira: [RC-138](https://nonameitem.atlassian.net/browse/RC-138)
- Disbanded tab — endpoints: /api/volumes/<slug>/disbanded/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:180) | tags: volumes | Jira: [RC-139](https://nonameitem.atlassian.net/browse/RC-139)
- First appearances tab — endpoints: /api/volumes/<slug>/first-appearances/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:181) | tags: volumes | Jira: [RC-130](https://nonameitem.atlassian.net/browse/RC-130)
- Missing issues link (staff) — endpoints: no DRF endpoint [N/A] | tags: volumes, missing-issues | Jira: [RC-223](https://nonameitem.atlassian.net/browse/RC-223)
- Technical info tab — endpoints: /api/volumes/<slug>/technical-info/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:166) | tags: volumes | Jira: [RC-222](https://nonameitem.atlassian.net/browse/RC-222)
- Start/stop watch — endpoints: /api/volumes/<slug>/start-watch/ [PLAN]; /api/volumes/<slug>/stop-watch/ [PLAN] | tags: volumes | Jira: [RC-142](https://nonameitem.atlassian.net/browse/RC-142)
- Mark finished — endpoints: /api/volumes/<slug>/mark-finished/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:170) | tags: volumes | Jira: [RC-224](https://nonameitem.atlassian.net/browse/RC-224)
- Download — endpoints: Django only [N/A] | tags: volumes | Jira: [RC-140](https://nonameitem.atlassian.net/browse/RC-140)

---

## Phase 6: Nested Issue Detail Pages

Issue detail pages within entity context (for prev/next navigation within sublist).
...
Subtasks:
- Reading progress (volume + character) — endpoints: /api/volumes/<slug>/ [NEEDS WORK]; /api/characters/<slug>/ [OK] | tags: characters, issues, volumes | Jira: [RC-228](https://nonameitem.atlassian.net/browse/RC-228)
...
Subtasks:
- Reading progress (volume + concept) — endpoints: /api/volumes/<slug>/ [NEEDS WORK]; /api/concepts/<slug>/ [OK] | tags: concepts, issues, volumes | Jira: [RC-230](https://nonameitem.atlassian.net/browse/RC-230)
...
Subtasks:
- Reading progress (volume + location) — endpoints: /api/volumes/<slug>/ [NEEDS WORK]; /api/locations/<slug>/ [OK] | tags: issues, locations, volumes | Jira: [RC-232](https://nonameitem.atlassian.net/browse/RC-232)
...
Tags: issues, objects
Subtasks:
- Reading progress (volume + object) — endpoints: /api/volumes/<slug>/ [NEEDS WORK]; /api/objects/<slug>/ [NEEDS WORK] | tags: issues, objects, volumes | Jira: [RC-234](https://nonameitem.atlassian.net/browse/RC-234)
- Previous/Next (within sublist) — endpoints: /api/objects/<slug>/issues/<issue_slug>/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:91) | tags: issues, objects | Jira: [RC-235](https://nonameitem.atlassian.net/browse/RC-235)
...
Tags: issues, people
Subtasks:
- Reading progress (volume + person) — endpoints: /api/volumes/<slug>/ [NEEDS WORK]; /api/people/<slug>/ [NEEDS WORK] | tags: issues, people, volumes | Jira: [RC-236](https://nonameitem.atlassian.net/browse/RC-236)
- Previous/Next (within sublist) — endpoints: /api/people/<slug>/issues/<issue_slug>/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:104) | tags: issues, people | Jira: [RC-237](https://nonameitem.atlassian.net/browse/RC-237)
...
Subtasks:
- Reading progress (volume + publisher) — endpoints: /api/volumes/<slug>/ [NEEDS WORK]; /api/publishers/<slug>/ [NEEDS WORK] | tags: issues, publishers, volumes | Jira: [RC-238](https://nonameitem.atlassian.net/browse/RC-238)
- Previous/Next (within sublist) — endpoints: /api/publishers/<slug>/issues/<issue_slug>/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:119) | tags: issues, publishers | Jira: [RC-239](https://nonameitem.atlassian.net/browse/RC-239)
...
Subtasks:
- Reading progress (volume + story arc) — endpoints: /api/volumes/<slug>/ [NEEDS WORK]; /api/story-arcs/<slug>/ [NEEDS WORK] | tags: issues, story-arcs, volumes | Jira: [RC-240](https://nonameitem.atlassian.net/browse/RC-240)
- Previous/Next (within sublist) — endpoints: /api/story-arcs/<slug>/issues/<issue_slug>/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:137) | tags: issues, story-arcs | Jira: [RC-241](https://nonameitem.atlassian.net/browse/RC-241)
...
Tags: issues, teams
Subtasks:
- Reading progress (volume + team) — endpoints: /api/volumes/<slug>/ [NEEDS WORK]; /api/teams/<slug>/ [NEEDS WORK] | tags: issues, teams, volumes | Jira: [RC-242](https://nonameitem.atlassian.net/browse/RC-242)
- Previous/Next (within sublist) — endpoints: /api/teams/<slug>/issues/<issue_slug>/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:152) | tags: issues, teams | Jira: [RC-243](https://nonameitem.atlassian.net/browse/RC-243)
...
Tags: issues, volumes
Subtasks:
- Reading progress (volume) — endpoints: /api/volumes/<slug>/ [NEEDS WORK] (ref: DRF_MIGRATION_URL_MAP.md:165) | tags: issues, volumes | Jira: [RC-244](https://nonameitem.atlassian.net/browse/RC-244)
- Previous/Next (within sublist) — endpoints: /api/volumes/<slug>/issues/<issue_slug>/ [PLAN; slug lookup pending] (ref: DRF_MIGRATION_URL_MAP.md:182) | tags: issues, volumes | Jira: [RC-245](https://nonameitem.atlassian.net/browse/RC-245)
...
Tags: search
Subtasks:
- Search form — endpoints: /api/search/ [PLAN] | tags: search | Jira: [RC-162](https://nonameitem.atlassian.net/browse/RC-162)
- Search results — endpoints: /api/search/ [PLAN] | tags: search | Jira: [RC-162](https://nonameitem.atlassian.net/browse/RC-162)
- AJAX autocomplete — endpoints: /api/search/ajax/ [PLAN] | tags: search | Jira: [RC-267](https://nonameitem.atlassian.net/browse/RC-267)

---

## Phase 8: Missing Issues (Admin)
...
### Task: 500 Error page ([RC-265](https://nonameitem.atlassian.net/browse/RC-265))
Description: Server error page
Tags: errors
Subtasks:
- Error display — endpoints: N/A | tags: errors | Jira: [RC-288](https://nonameitem.atlassian.net/browse/RC-288)

### Task: 404 Error page ([RC-266](https://nonameitem.atlassian.net/browse/RC-266))
Description: Page not found
Tags: errors
Subtasks:
- Error display — endpoints: N/A | tags: errors | Jira: [RC-289](https://nonameitem.atlassian.net/browse/RC-289)
...
| Phase | Tasks | Subtasks | API Status |
|-------|-------|----------|------------|
| 1. Auth & User | 8 | ~20 | Mostly OK (dj-rest-auth) |
| 2. Home & Dashboard | 2 | 6 | Mostly OK |
| 3. Entity Lists | 12 | 12 | All OK |
| 4. Entity Details (Ready) | 4 | ~50 | OK + PLAN nested |
| 5. Entity Details (Need Work) | 7 | ~100 | NEEDS WORK + PLAN |
| 6. Nested Issue Details | 9 | 18 | NEEDS WORK + PLAN |
| 7. Search | 1 | 3 | PLAN |
| 8. Missing Issues | 13 | ~30 | NOT READY + PLAN |
| 9. Error Pages | 2 | 2 | N/A |

### Backend Work Required

1. **Detail Serializers** (7 entities): Objects, People, Publishers, Story Arcs, Teams, Volumes, Missing Issues
2. **Slug Lookup** (6 entities): Objects, People, Publishers, Story Arcs, Teams, Volumes
3. **Nested Endpoints** (~100): All `/<entity>/<slug>/issues/`, `/volumes/`, etc.
4. **Action Endpoints** (~30): `start-watch`, `stop-watch`, `mark-read`, `mark-finished`
5. **Search API**: `/api/search/`, `/api/search/ajax/`
6. **User Profile API**: `/api/profile/change-photo/`, `/api/profile/delete-photo/`

### Recommended Execution Order

1. **Phase 1** - Auth (enables user testing early)
2. **Phase 3** - Entity Lists (all API ready, good for establishing patterns)
3. **Phase 2** - Home (depends on list patterns)
4. **Phase 4** - Character/Concept/Issue/Location detail (API ready)
5. **Backend work** - Detail serializers + slug lookup
6. **Phase 5** - Remaining detail pages
7. **Phase 6** - Nested issue details
8. **Phase 7** - Search
9. **Phase 8** - Missing Issues (admin only)
10. **Phase 9** - Error pages
