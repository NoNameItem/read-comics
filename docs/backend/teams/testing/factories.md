# Team Factories in `read_comics/teams/tests/factories.py`

## Summary

- [`TeamFactory`](#teamsfactory) - Factory for creating Team instances

## Reference

### TeamFactory

Factory class for generating Team model instances with realistic test data.

**Extends:** [`ComicvineSyncModelFactory`](../../../utils/test_utils_factories.md#comicvinesyncmodelfactory)

**Location:** `read_comics/teams/tests/factories.py`
...
- **Behavior:** Creates N Issue instances and associates them with the teams
- **Usage:** `TeamFactory(add_issues=5)`
...
teams = TeamFactory(add_issues=10)

# Batch creation
teams_list = TeamFactory.create_batch(size=20)
```

#### Dependencies

- `read_comics.teams.models.Team`
