...
const { isLoading: infoLoading, data: info } = useQuery(queries.concepts.detail(route.params.slug));
...
const { isLoading: technicalInfoLoading, preparedTechnicalInfo } = usePreparedTechnicalInfo(
  queries.concepts.detail(route.params.slug)._ctx.technicalInfo
);
</script>
